...
from py3votecore.schulze_by_graph import SchulzeMethodByGraph
from py3votecore.schulze_by_graph import SchulzeNPRByGraph
...
class TestSchulzeNPRByGraph(unittest.TestCase):
    ...
    def test_complex_example(self):
        ...
        output = SchulzeNPRByGraph(
            input, winner_threshold=3, tie_breaker=["a", "d", "c", "b"]
        ).as_dict()
